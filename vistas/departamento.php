...
<body>
    ...
    <div class="container">
        ...
        <div class="col table-container">
            <table id="tablaDepartamento" class="table table-striped table-bordered"></table>
        </div>
    </div>
                ...
                <form id="formDepartamentos">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="departamento" placeholder="Ingrese el nombre del departamento">
                        </div>
    ...
    <script src="../Funcionesjs/funcionDepartamento.js"></script>
</body>
</html>